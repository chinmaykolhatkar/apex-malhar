...
public class SqlCreateFunction extends SqlCall
{
  public static final SqlSpecialOperator OPERATOR = new SqlSpecialOperator("CREATE_FUNCTION", SqlKind.OTHER)
  {
    ...
    public SqlCall createCall(SqlLiteral functionQualifier, SqlParserPos pos, SqlNode... o)
    {
      ...
      return new SqlCreateFunction(pos, (SqlIdentifier)o[0], o[1], o[2], o[3]);
    }
    ...
    public void unparse(SqlWriter writer, SqlCall call, int leftPrec, int rightPrec)
    {
      ...
      u.keyword("CREATE", "FUNCTION").node(t.functionName).keyword("AS").node(t.className).node(t.classFnName);
      if (t.jarName != null) {
  ...
  private final SqlNode classFnName;
  private final SqlNode jarName;

  public SqlCreateFunction(SqlParserPos pos, SqlIdentifier functionName, SqlNode className, SqlNode classFnName,
      SqlNode jarName)
  {
    super(pos);
    this.functionName = functionName;
    this.className = className;
    this.classFnName = classFnName;
  ...
  {
    return ImmutableNullableList.of(functionName, className, classFnName);
  }
  ...
  public String classFnName()
  {
    return ((NlsString)SqlLiteral.value(classFnName)).getValue();
  }
